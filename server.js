...
// app.post('/index-employees', async (req, res) => {
//     const results = [];
...
//                             annualSalary: employee['Annual Salary'],
//                             bonusPercentage: employee['Bonus %'],
//                             country: employee['Country'],
//                             city: employee['City'],
//                             exitDate: employee['Exit Date'],
//                         },
//                     });
//                 }
//                 res.status(201).send({ message: 'Data indexed successfully' });
//             } catch (error) {
